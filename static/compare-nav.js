/**
 * SELA å ±é…¬çŽ‡æ¯”è¼ƒåŠŸèƒ½ - å°Žèˆªé€£çµæ³¨å…¥
...
(function() {
    ...
    // å¦‚æžœ DOM å·²ç¶“è¼‰å…¥å®Œæˆï¼Œç›´æŽ¥åŸ·è¡Œ
    ...
    function injectCompareLinks() {
        ...
        // æ‰¾åˆ°ã€Œè¨­å®šã€é€£çµä¸¦åœ¨å…¶å¾Œæ’å…¥
        // æ¡Œé¢ç‰ˆ
        const desktopSettingsLinks = document.querySelectorAll('a.nav-link');
        desktopSettingsLinks.forEach(function(link) {
            if (link.textContent.includes('è¨­å®š') && !link.nextElementSibling?.textContent?.includes('å ±é…¬çŽ‡')) {
        ...
        console.log('âœ… å ±é…¬çŽ‡æ¯”è¼ƒé€£çµå·²æ³¨å…¥');
    }
        ...
        const quickAccessHTML = `
            <div class="compare-quick-access bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl shadow-lg p-4 mb-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="font-bold text-lg">ðŸ† å ±é…¬çŽ‡æ¯”è¼ƒ</h3>
