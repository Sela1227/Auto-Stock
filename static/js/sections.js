/**
 * Section å…§å®¹å‹•æ…‹ç”Ÿæˆæ¨¡çµ„
 * å°‡æ‰€æœ‰ section HTML å¾ž dashboard.html ç§»å‡º
 */
(function() {
    'use strict';
    ...
    const SECTION_TEMPLATES = {
        dashboard: `<h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-6">å„€è¡¨æ¿</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-4 md:mb-6">
                ${renderGauge('stock', 'ç¾Žè‚¡ææ‡¼è²ªå©ªæŒ‡æ•¸', 'fas fa-flag-usa', 'blue')}
                ${renderGauge('crypto', 'å¹£åœˆææ‡¼è²ªå©ªæŒ‡æ•¸', 'fab fa-bitcoin', 'orange')}
            </div>
        ...
        watchlist: `<div class="flex items-center justify-between mb-4 md:mb-6">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button onclick="showAddWatchlistModal()" class="brand-orange text-white px-4 py-2 rounded-lg font-medium flex items-center touch-target"><i class="fas fa-plus mr-2"></i><span class="hidden sm:inline">æ–°å¢ž</span></button>
                </div>
            </div>
            <div id="watchlistContent"><p class="text-gray-500 text-center py-4">è¼‰å…¥ä¸­...</p></div>`,

        sentiment: `<h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-6">ææ‡¼è²ªå©ªæŒ‡æ•¸</h2>
        ...
        compare: `<h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-6">èµ°å‹¢æ¯”è¼ƒ</h2>
            ...
            <div id="compareResultTable" class="bg-white rounded-xl shadow p-4 md:p-6 hidden">
                <h3 class="font-semibold text-gray-700 mb-4"><i class="fas fa-table mr-2 text-purple-500"></i>æ¯”è¼ƒçµæžœ</h3>
        ...
        portfolio: `<div class="flex items-center justify-between mb-4 md:mb-6">
            ...
            <div class="flex gap-2 mb-4 border-b">
                ...
                <button onclick="switchPortfolioMarket('us')" id="portfolioTabUs" class="px-4 py-2 border-b-2 border-transparent text-gray-500 hover:text-gray-700"><i class="fas fa-flag-usa mr-1"></i>ç¾Žè‚¡</button>
            </div>
            <div id="portfolioTwSection">
                <button onclick="showTwModal()" class="w-full mb-4 py-3 border-2 border-dashed border-red-300 text-red-500 rounded-xl hover:bg-red-50"><i class="fas fa-plus mr-2"></i>æ–°å¢žå°è‚¡äº¤æ˜“</button>
                <div class="bg-white rounded-xl shadow p-4 mb-4"><h3 class="font-semibold text-gray-700 mb-3 flex items-center"><i class="fas fa-chart-pie mr-2 text-red-500"></i>å°è‚¡æŒè‚¡ç¸½è¦½</h3><div id="twHoldingsSummary" class="text-center py-4 text-gray-400">è¼‰å…¥ä¸­...</div></div>
                <div class="bg-white rounded-xl shadow p-4 mb-4"><h3 class="font-semibold text-gray-700 mb-3 flex items-center justify-between"><span><i class="fas fa-list mr-2 text-red-500"></i>æŒè‚¡æ˜Žç´°</span><span class="text-sm text-gray-400" id="twHoldingsCount">0 æª”</span></h3><div id="twHoldingsList" class="space-y-3"><p class="text-center py-4 text-gray-400">è¼‰å…¥ä¸­...</p></div></div>
            ...
            <div id="portfolioUsSection" class="hidden">
                <button onclick="showUsModal()" class="w-full mb-4 py-3 border-2 border-dashed border-blue-300 text-blue-500 rounded-xl hover:bg-blue-50"><i class="fas fa-plus mr-2"></i>æ–°å¢žç¾Žè‚¡äº¤æ˜“</button>
                <div class="bg-white rounded-xl shadow p-4 mb-4"><h3 class="font-semibold text-gray-700 mb-3 flex items-center"><i class="fas fa-chart-pie mr-2 text-blue-500"></i>ç¾Žè‚¡æŒè‚¡ç¸½è¦½</h3><div id="usHoldingsSummary" class="text-center py-4 text-gray-400">è¼‰å…¥ä¸­...</div></div>
                <div class="bg-white rounded-xl shadow p-4 mb-4"><h3 class="font-semibold text-gray-700 mb-3 flex items-center justify-between"><span><i class="fas fa-list mr-2 text-blue-500"></i>æŒè‚¡æ˜Žç´°</span><span class="text-sm text-gray-400" id="usHoldingsCount">0 æª”</span></h3><div id="usHoldingsList" class="space-y-3"><p class="text-center py-4 text-gray-400">è¼‰å…¥ä¸­...</p></div></div>
        ...
        settings: `<h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-6">è¨­å®š</h2>
            ...
            <div class="bg-white rounded-xl shadow p-4 md:p-6 mb-4">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <button onclick="showTagEditModal()" class="px-3 py-1 bg-indigo-500 text-white text-sm rounded-lg hover:bg-indigo-600"><i class="fas fa-plus mr-1"></i>æ–°å¢ž</button>
                </div>
        ...
        cagr: `<h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-6">å ±é…¬çŽ‡æ¯”è¼ƒ</h2>
            <div class="bg-white rounded-xl shadow p-4 md:p-6 mb-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    ...
                    <div><label class="block text-gray-700 mb-2 text-sm">çµæŸæ—¥æœŸ</label><input type="date" id="cagrEndDate" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-green-500"></div>
                </div>
                <div class="flex gap-2">
                    <button onclick="calculateCAGR()" class="px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600"><i class="fas fa-calculator mr-2"></i>è¨ˆç®—å ±é…¬çŽ‡</button>
            ...
            <div id="cagrResults" class="hidden">
                <div class="bg-white rounded-xl shadow p-4 md:p-6 mb-4"><h3 class="font-semibold text-gray-700 mb-3 flex items-center"><i class="fas fa-trophy mr-2 text-green-500"></i>å ±é…¬çŽ‡æŽ’å</h3><div id="cagrRankingList" class="space-y-3"></div></div>
        ...
        admin: `<h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-6"><i class="fas fa-user-shield mr-2 text-orange-500"></i>ç®¡ç†å¾Œå°</h2>
            ...
            <div class="bg-white rounded-xl shadow p-4 md:p-6 mb-4">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <button onclick="adminClearOldCache()" class="px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600"><i class="fas fa-broom mr-2"></i>æ¸…ç†éŽæœŸå¿«å–</button>
                </div>
