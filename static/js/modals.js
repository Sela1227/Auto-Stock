/**
 * Modal å‹•æ…‹ç”Ÿæˆæ¨¡çµ„
 * å°‡æ‰€æœ‰ Modal HTML å¾ž dashboard.html ç§»å‡ºï¼Œæ”¹ç‚º JavaScript å‹•æ…‹å‰µå»º
 * 
 * ä½¿ç”¨æ–¹å¼ï¼š
...
(function() {
            ...
            <div id="chartFullscreen" class="chart-fullscreen">
                <div class="chart-container h-full flex flex-col">
                    <div class="rotate-banner">
                        ðŸ“± æ©«å‘æ”¾ç½®æ‰‹æ©Ÿå¯ç²å¾—æ›´å¥½çš„åœ–è¡¨é«”é©—
                    </div>
                ...
                <div class="bg-white rounded-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
                    <div class="sticky top-0 bg-white p-4 border-b flex items-center justify-between">
                        <h3 class="text-lg font-bold text-gray-800">
                            ...
                            <span id="returnsModalTitle">å¹´åŒ–å ±é…¬çŽ‡</span>
                        </h3>
                ...
                <div class="bg-white rounded-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
                    <div class="sticky top-0 bg-white p-4 border-b flex items-center justify-between">
                        <h3 class="text-lg font-bold text-gray-800">
                            ...
                            <span id="twModalTitle">æ–°å¢žå°è‚¡äº¤æ˜“</span>
                        </h3>
                    ...
                    <div class="p-4">
                        ...
                        <!-- è‚¡ç¥¨åç¨±ï¼ˆå”¯è®€ï¼‰ -->
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2 text-sm">è‚¡ç¥¨åç¨±</label>
                        ...
                        <!-- æˆäº¤åƒ¹ -->
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2 text-sm">æˆäº¤åƒ¹ <span class="text-red-500">*</span></label>
                ...
                <div class="bg-white rounded-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
                    <div class="sticky top-0 bg-white p-4 border-b flex items-center justify-between">
                        <h3 class="text-lg font-bold text-gray-800">
                            ...
                            <span id="usModalTitle">æ–°å¢žç¾Žè‚¡äº¤æ˜“</span>
                        </h3>
                    ...
                    <div class="p-4">
                        ...
                        <!-- æˆäº¤åƒ¹ -->
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2 text-sm">æˆäº¤åƒ¹ (USD) <span class="text-red-500">*</span></label>
        ...
        addWatchlistModal: `
            <div id="addWatchlistModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-[3000] p-4">
                <div class="bg-white rounded-xl w-full max-w-md p-6 max-h-[90vh] overflow-y-auto">
                    <h3 class="text-lg font-bold text-gray-800 mb-4">æ–°å¢žè¿½è¹¤</h3>
                    <div class="space-y-4">
                        <div>
                        ...
                        <div>
                            <label class="block text-gray-700 mb-2 text-sm">é¡žåž‹</label>
                    ...
                    <div class="flex gap-3 mt-6">
                        ...
                        <button onclick="addToWatchlist()" class="flex-1 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 touch-target">æ–°å¢ž</button>
                    </div>
                </div>
            </div>
        `,
            ...
            <div id="targetPriceModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-[3000] p-4">
                <div class="bg-white rounded-xl w-full max-w-sm p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block text-gray-700 mb-2 text-sm">æé†’æ–¹å‘</label>
                            <div class="grid grid-cols-2 gap-3">
                                <label id="labelAbove" class="flex items-center justify-center p-3 border-2 rounded-lg cursor-pointer hover:bg-green-50 border-gray-200">
                                    ...
                                    <span class="text-center">
                                        ...
                                        <div class="text-sm font-medium mt-1">é«˜æ–¼æ™‚æé†’</div>
                                        <div class="text-xs text-gray-500">çªç ´è²·å…¥</div>
                                    </span>
                                </label>
                                <label id="labelBelow" class="flex items-center justify-center p-3 border-2 rounded-lg cursor-pointer hover:bg-red-50 border-gray-200">
                                    ...
                                    <span class="text-center">
                                        ...
                                        <div class="text-sm font-medium mt-1">ä½Žæ–¼æ™‚æé†’</div>
                                        <div class="text-xs text-gray-500">è·Œç ´åœæ</div>
                                    </span>
                                </label>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-xl w-full max-w-md mx-4 p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h3 id="tagModalTitle" class="text-lg font-bold text-gray-800">
                            <i class="fas fa-tag mr-2 text-blue-500"></i>æ–°å¢žæ¨™ç±¤
                        </h3>
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">æ¨™ç±¤åç¨±</label>
                            <input type="text" id="tagNameInput" placeholder="ä¾‹å¦‚ï¼šé•·æœŸæŒæœ‰" maxlength="50"
    ...
    function initAllModals() {
        ...
        console.log('âœ… æ‰€æœ‰ Modal å·²åˆå§‹åŒ–');
    }
    ...
    // è‡ªå‹•åˆå§‹åŒ–ï¼ˆç•¶ DOM è¼‰å…¥å®Œæˆæ™‚ï¼‰
