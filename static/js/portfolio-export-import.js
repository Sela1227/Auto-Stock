/**
 * æŒè‚¡äº¤æ˜“åŒ¯å‡ºåŒ¯å…¥åŠŸèƒ½
 * P1 åŠŸèƒ½å¢žå¼·
 * 
 * åœ¨ç¾æœ‰ portfolio.js åŸºç¤Žä¸Šæ–°å¢žåŒ¯å‡ºåŒ¯å…¥åŠŸèƒ½
 */
...
(function() {
    ...
    function previewTransactionsFile(input) {
        ...
        reader.onload = function(e) {
            try {
                ...
                preview.innerHTML = `<p class="text-red-500 p-3"><i class="fas fa-times-circle mr-2"></i>æª”æ¡ˆè§£æžå¤±æ•—: ${err.message}</p>`;
            }
        };
    ...
    /**
     * è§£æž CSV è¡Œï¼ˆè™•ç†å¼•è™Ÿå…§çš„é€—è™Ÿï¼‰
     */
            ...
            <div class="relative">
                ...
                <div id="portfolioMenu" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border z-50">
                    ...
                    <button onclick="exportTransactions('json', 'us')" class="w-full text-left px-4 py-2 hover:bg-gray-50 text-sm text-gray-700 flex items-center">
                        <i class="fas fa-download mr-2 text-blue-500"></i>åƒ…ç¾Žè‚¡ JSON
                    </button>
                    <hr class="my-1">
    ...
    console.log('ðŸ“¦ portfolio-export-import.js æ¨¡çµ„å·²è¼‰å…¥');
})();