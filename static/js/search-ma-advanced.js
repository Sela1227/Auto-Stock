...
(function() {
    ...
    function renderCrossSignals(ma) {
        ...
        for (const s of signals) {
            ...
            const icon = s.type === 'golden' ? 'ðŸ”º' : 'ðŸ”»';
    ...
    function renderAlignment(ma) {
        ...
        const icon = status === 'bullish' ? 'ðŸ“ˆ' : status === 'bearish' ? 'ðŸ“‰' : 'ðŸ“Š';
        
        let html = '<div class="mb-4"><div class="flex items-center mb-2"><i class="fas fa-layer-group text-orange-500 mr-2"></i><span class="text-sm font-medium text-gray-700">å‡ç·šæŽ’åˆ—</span></div>';
    ...
    function renderSupportResistance(ma) {
        ...
        html += '<div class="p-2 rounded bg-green-50 border border-green-200"><div class="text-xs text-green-600 mb-1">ðŸ“— æ”¯æ’</div>';
        ...
        html += '<div class="p-2 rounded bg-red-50 border border-red-200"><div class="text-xs text-red-600 mb-1">ðŸ“• å£“åŠ›</div>';
    ...
    console.log('ðŸ“Š search-ma-advanced.js å·²è¼‰å…¥');
})();